  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-md mx-auto">
        <div className="bg-white border border-line rounded-md p-5 sm:p-8 text-center">
          ...
          {site.showPrices && course.discount ? (
            <>
              ...
              <p className="mb-1 flex flex-wrap items-baseline justify-center gap-x-3">
                <span className="text-gray-400 line-through text-2xl sm:text-3xl font-medium">
