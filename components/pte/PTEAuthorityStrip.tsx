...
// facts — no Pearson-certified-trainer, PTE-examiner or partner claim, and the IELTS-specific IDP
// credential is deliberately not shown here (it's IELTS certification, not PTE authority).
...
export default function PTEAuthorityStrip() {
  return (
