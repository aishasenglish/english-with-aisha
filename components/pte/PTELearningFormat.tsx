...
// <LearningFormats> renders on this page (PTE Step 5). Two clearly separate lists side by side at
// lg+: the left column is the stable, already-approved teaching method (Steps 2-4) with no icon
...
// confirm" marker rather than a checkmark so the two lists can never be mistaken for the same
// kind of claim.
export default function PTELearningFormat() {
  const { delivery } = ptePage;

  return (
    <section
      id={delivery.id}
      className="py-14 sm:py-16 px-4 bg-white"
      aria-labelledby="pte-learning-format-heading"
    >
      <div className="max-w-5xl mx-auto">
        <div className="max-w-2xl mb-8 sm:mb-10">
          ...
          <h2 id="pte-learning-format-heading" className="font-serif text-2xl sm:text-3xl font-medium text-ink mb-3">
            {delivery.heading}
          </h2>
