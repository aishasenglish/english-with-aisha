...
export default function PTEScoreProfile() {
  const { scoreProfile } = ptePage;

  return (
    <section className="py-14 sm:py-16 px-4 bg-white" aria-labelledby="pte-score-profile-heading" id={scoreProfile.id}>
      <div className="max-w-4xl mx-auto">
        <div className="max-w-2xl mb-8 sm:mb-10">
          ...
          <h2 id="pte-score-profile-heading" className="font-serif text-2xl sm:text-3xl font-medium text-ink mb-3">
