...
//
// IELTS Step 9: the secondary action is decided here, on the server, from formsAreConfigured() —
...
// content the candidate has already read.
export default function IELTSFinalCTA() {
  const { finalCta } = ieltsPage;
  ...
  return (
    <section
      ...
      aria-labelledby="ielts-enquiry-heading"
    >
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 id="ielts-enquiry-heading" className="font-serif text-[1.75rem] sm:text-3xl md:text-4xl font-medium text-ink mb-4 leading-tight">
          {finalCta.heading}
        </h2>
