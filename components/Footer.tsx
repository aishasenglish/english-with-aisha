        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              {(Object.entries(site.socials) as [string, string][]).map(
                ([key, url]) =>
                  socialIcons[key] ? (
                    <a
                      key={key}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-white/70">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <li>
                ...
                >
                  <svg className="w-4 h-4 shrink-0 text-gold" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-white/70 hover:text-white transition-colors"
                >
                  <svg className="w-4 h-4 shrink-0 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
