...
// Server component. The required-detail panel is informational reference material, not a form or
// a sequence — plain checkmark bullets rather than numbered circles, since order doesn't matter.
export default function TOEFLScoreProfile() {
  const { scoreProfile } = toeflPage;

  return (
    <section className="py-14 sm:py-16 px-4 bg-white" aria-labelledby="toefl-score-profile-heading" id={scoreProfile.id}>
      <div className="max-w-4xl mx-auto">
        <div className="max-w-2xl mb-8 sm:mb-10">
          ...
          <h2 id="toefl-score-profile-heading" className="font-serif text-2xl sm:text-3xl font-medium text-ink mb-3">
