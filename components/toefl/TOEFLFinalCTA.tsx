...
// depends on for one page's layout. Mirrors components/pte/PTEFinalCTA.tsx.
//
// TOEFL Step 9: the secondary action is decided here, on the server, from formsAreConfigured() —
