...
export default function CourseExplorer() {
  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-4 relative z-10 -mt-8 sm:-mt-12 lg:-mt-16" id="finder">
        <form
          className="bg-white border border-stone border-t-4 border-t-coral shadow-lg p-4 sm:p-6 lg:p-7"
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-2 mb-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
            <label className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="w-full min-h-12 px-3 sm:px-4 py-3 rounded-sm border border-line-strong bg-white text-ink text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-coral cursor-pointer"
              >
            ...
            <button
              type="submit"
              className="min-h-12 rounded-sm bg-coral hover:bg-amber-dark text-white font-serif font-medium uppercase tracking-wide text-sm px-6 py-3 transition-colors"
            >
              Show courses
            </button>
          </div>
