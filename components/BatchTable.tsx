      ...
      <table className="w-full text-sm">
        <thead className="bg-sea text-white">
          <tr>
            ...
            <th className="text-left px-6 py-4 font-semibold">Enroll</th>
          </tr>
        </thead>
        <tbody>
          {batches.map((batch, i) => (
            ...
            >
              ...
              <td className="px-6 py-4">
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${statusClasses[batch.status]}`}
                >
                  {batch.status}
                </span>
              </td>
              <td className="px-6 py-4">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-teal font-semibold hover:text-ink transition-colors"
                >
