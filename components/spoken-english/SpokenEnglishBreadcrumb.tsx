...
// app/courses/spoken-english/page.tsx -- both read from the same content/spokenEnglish.ts
...
// components/toefl/TOEFLBreadcrumb.tsx / components/pte/PTEBreadcrumb.tsx / components/ielts/
// IELTSBreadcrumb.tsx.
export default function SpokenEnglishBreadcrumb() {
  const { breadcrumb } = spokenEnglishPage;
