...
// depends on for one page's layout. Mirrors components/toefl/TOEFLFinalCTA.tsx and
// components/pte/PTEFinalCTA.tsx.
//
...
// "spoken-english" is deliberately absent from lib/analytics's programme/source allowlists until a
// reviewed Step 12 extension (see content/spokenEnglishEnquiry.ts's doc comment).
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="text-left bg-white border border-stone rounded-md p-5 sm:p-6 mb-7 sm:mb-8">
          ...
          <ul className="space-y-2">
            {spokenEnglishEnquiryFields.map((field) => (
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 justify-center mb-6">
          <a
            href={whatsappLink(spokenEnglishFinalEnquiry.whatsappMessage)}
            target="_blank"
          ...
          {formConfigured ? (
            <Link
              href="/free-diagnostic-test?programme=spoken-english&source=spoken-english-page"
            ...
            <a
              href={emailLink(spokenEnglishFinalEnquiry.emailSubject, spokenEnglishFinalEnquiry.emailBody, site.email)}
