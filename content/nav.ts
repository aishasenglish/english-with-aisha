...
export const NAV: NavItem[] = [
  ...
  },
  {
    ...
    feature: {
      tag: "Band 8.0",
      title: "“Exam day felt like just another practice.”",
      body: "Ali Raza sat weekly mock exams before his IELTS test date.",
      cta: { label: "Read his story", href: "/success-stories" },
      style: "arrow",
    },
  },
  {
