 ...
 * exact-match route list (PTE Step 11) so a route that earns this treatment is added in one
 * place instead of two near-duplicate inline `pathname === "/courses/ielts"` conditions. Exact
 * matching only — a nested path under one of these routes does not automatically qualify.
 */
