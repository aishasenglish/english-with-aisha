 ...
 * English in Spoken English Step 11, extended to English Writing in English Writing Step 11) so a
 * route that earns this treatment is added in one place instead of near-duplicate inline
 * `pathname === "/courses/ielts"` conditions. Exact matching only — a nested path under one of
 * these routes does not automatically qualify.
 */
