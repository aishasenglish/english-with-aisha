    ...
    <>
      ...
      <section className="py-20 px-4 bg-ivory">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 bg-white rounded-md border border-stone p-10 text-center">
            ...
            <p className="font-serif text-xl font-medium text-ink mb-2">Video testimonials coming soon</p>
