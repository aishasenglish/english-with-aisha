...
export const metadata: Metadata = {
  ...
  description:
    "Live online English coaching for IELTS, PTE, TOEFL, English Writing, and Spoken English. Expert-led by Aisha — MPhil in English Literature, College Lecturer. Classes recorded. New batch every 15 days.",
  openGraph: {
    type: "website",
    locale: "en_GB",
